...
async function main() {
  ...
  await prisma.systemSetting.upsert({
    ...
    create: {
      id: "1",
      siteTitle: "Cresce Reels - Impulsione seu Instagram",
      siteDescription: "Aumente suas visualizações no Reels de forma rápida, segura e sem senha.",
  ...
  const plansList = [
    ...
    { name: "VIRAL", viewsAmount: 28000, price: 28.00, originalPrice: 50.00, isPopular: false, badge: "HOT" },
    { name: "INFLUENCER", viewsAmount: 80000, price: 80.00, originalPrice: 144.00, isPopular: false, badge: "MAIS VENDIDO" },
    { name: "SUPREME", viewsAmount: 130000, price: 130.00, originalPrice: 234.00, isPopular: false, badge: null },
    { name: "MEGA", viewsAmount: 350000, price: 250.00, originalPrice: 450.00, isPopular: false, badge: "PREMIUM" },
    { name: "ULTIMATE", viewsAmount: 600000, price: 150.00, originalPrice: 600.00, isPopular: false, badge: "OFERTA ESPECIAL" },
    { name: "ULTRA", viewsAmount: 700000, price: 200.00, originalPrice: 360.00, isPopular: false, badge: "HOT DEAL" },
    { name: "1 MILHÃO", viewsAmount: 1000000, price: 400.00, originalPrice: 720.00, isPopular: false, badge: "MEGA PACK" },
  ];
